  ...
  return(
    <section id="contact-section">
      <div className="info-container">
        <h1 className="heading">Our Priority is to <br />
            Ensure the Good <br />
            Health of your <br />
            Swine
        </h1>
        <p className="inform-txt">
          Always be informed and updated to the services we provide by joining our community.
        </p>
      ...
      <form action="" className="appointment-form">
        ...
        <button type="submit" class="request-appointment-btn">Request Appointment</button>
      </form>
    </section>
  )
}
